...
/**
 * @openapi
 * /api/v1/developer/providers/bulk-delete:
 *   post:
 *     tags: [Developer]
 *     summary: Delete multiple Providers in one call
 *     description: >
 ...
 */
router.post('/bulk-delete', validateBody(bulkDeleteSchema), developerProviderController.bulkDelete);
