...
This document describes the architecture of the Persona.ai backend as it is currently implemented. It differentiates between what actually exists, what appears to be intended, what is inconsistent, and what is missing.
