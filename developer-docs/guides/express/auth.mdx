...
description: How @personaai/adapters/express connects your own authentication to Persona — the runtime-level resolver and the Express middleware pattern, and the 401 behavior.
---
