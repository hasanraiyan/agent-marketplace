...
description: How @personaai/adapters/nestjs connects your own authentication to Persona — the runtime-level resolver and the NestJS request-level resolver, and the 401 behavior.
---
