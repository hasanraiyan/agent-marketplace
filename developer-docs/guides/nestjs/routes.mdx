---
title: Routes
description: Every route the @personaai/adapters/nestjs middleware exposes, how it translates NestJS requests, and which SDK call each route proxies to.
---
...
`restToolsManifest` to `PersonaModule.forRoot`/`forRootAsync`, it's never gated behind
