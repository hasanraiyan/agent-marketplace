...
description: How @personaai/adapters/nextjs connects your own authentication to Persona — the Request-level resolver, the runtime-level resolver, Clerk/NextAuth recipes, and the 401 behavior.
---
