...
description: How @personaai/adapters/nextjs streams AG-UI chat as SSE from a route handler, honors backpressure, tears down on disconnect, runs on the Edge runtime, and what reconnect means on serverless.
---
