---
title: Uploads
description: How @personaai/adapters/nextjs handles multipart file uploads — native FormData parsing, form-field mapping, body-size limits, and binary downloads.
---
