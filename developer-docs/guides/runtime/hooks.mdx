...
description: All eight RuntimeHooks — plain async event listeners fired around chat/architect runs, tool calls, file uploads, thread creation, and memory writes.
---
