...
const runtime = createRuntime({
  ...
  restToolsManifest: {
    ...
    // Must match the API Key you configure on the Persona-side REST Tool
    // Source. Omit only for local/dev testing — it leaves the route open.
...
`https://your-app.com{mountPath}/rest-tools/manifest`, Auth = API Key = the same
