...
| `.voice`       | `VoiceResource`            | `/api/v1/developer/voice/sessions` (ticket mint only — see [Voice](/guides/sdk/resources/voice)) | Requires `externalUserId` — a voice call always runs as one end user. |
