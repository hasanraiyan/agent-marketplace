...
export interface FileExplorerEditorProps<T extends ExplorerItem> {
   ...
   * Omit entirely for a fixed, single-item domain (e.g. one thread's
   * workspace) where there is no "create another item" action — the
   * Explorer header's "+" and the empty-state action button are both
