    ...
    >
      <Streamdown
        className={cn(
          ...
          "[&_li]:leading-relaxed",
          // Links: semantic theme primary
          "[&_a]:text-primary [&_a]:underline [&_a]:underline-offset-4 [&_a]:font-medium hover:[&_a]:opacity-80",
          // Inline code chips
          ...
          "[&_blockquote]:my-4 [&_blockquote]:border-l-4 [&_blockquote]:border-primary [&_blockquote]:bg-muted/40 [&_blockquote]:px-4 [&_blockquote]:py-3 [&_blockquote]:rounded-r-md [&_blockquote]:text-foreground/90 [&_blockquote_p]:my-1",
          // Tables
