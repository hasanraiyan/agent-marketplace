 ...
 *
 * This package installs the adapter as a consumer would (`@personaai/adapters`
 ...
 * adapters root with `pnpm test:express4`.
 */
...
describe('@personaai/adapters/express on Express 4', () => {
