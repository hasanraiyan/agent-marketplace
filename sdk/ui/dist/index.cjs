...
function PersonaToolGroup({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: cn("my-2 min-w-0", className), children: [
      ...
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex min-w-0 items-center gap-2", children: [
            anyRunning ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react3.Loader2, { className: "size-4 shrink-0 animate-spin text-blue-500" }) : hasError ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react3.AlertCircle, { className: "size-4 shrink-0 text-red-500" }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react3.CheckCircle2, { className: "size-4 shrink-0 text-emerald-500" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ClusterIcon, { className: "size-4 shrink-0 text-zinc-400 dark:text-zinc-500" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "truncate", children: title }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "shrink-0 text-[10px] font-normal text-zinc-400 dark:text-zinc-500", children: [
              tools.length,
              " step",
              tools.length > 1 ? "s" : ""
            ] })
          ] }),
          isOpen ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react3.ChevronUp, { className: "size-3.5 shrink-0" }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react3.ChevronDown, { className: "size-3.5 shrink-0" })
        ]
      }
    ),
    isOpen && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "mt-2 space-y-2 pl-4", children: tools.map((tool) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      PersonaToolTrace,
      {
        toolCall: tool,
        toolRenderers,
...
function CodeBlock({ className, children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "group/code relative my-2 overflow-hidden rounded-xl border border-zinc-200/80 dark:border-zinc-800/80", children: [
    language && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "flex items-center justify-between bg-zinc-100 px-3 py-1 text-[10px] font-semibold uppercase tracking-wider text-zinc-500 dark:bg-zinc-900 dark:text-zinc-400", children: language }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      "button",
      {
        ...
        children: copied ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react4.Check, { className: "size-3.5 text-emerald-500" }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react4.Copy, { className: "size-3.5" })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("pre", { className: "overflow-x-auto bg-zinc-950 p-3 text-xs leading-relaxed text-zinc-100", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("code", { className: "whitespace-pre break-words font-mono", children: text }) })
  ] });
}
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        import_react_markdown.default,
        {
          ...
          components: {
            p: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "my-2 whitespace-pre-wrap break-words", children }),
            ...
            ul: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("ul", { className: "my-2 list-disc space-y-1 pl-5", children }),
            ol: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("ol", { className: "my-2 list-decimal space-y-1 pl-5", children }),
            li: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("li", { className: "pl-0.5", children }),
            h1: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h1", { className: "mb-2 mt-4 text-base font-bold text-zinc-900 dark:text-zinc-100", children }),
            h2: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h2", { className: "mb-1.5 mt-3 text-[15px] font-bold text-zinc-900 dark:text-zinc-100", children }),
            h3: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h3", { className: "mb-1 mt-3 text-sm font-bold text-zinc-900 dark:text-zinc-100", children }),
            h4: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h4", { className: "mb-1 mt-2 text-[13px] font-bold text-zinc-900 dark:text-zinc-100", children }),
            blockquote: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("blockquote", { className: "my-2 border-l-2 border-zinc-300 pl-3 text-zinc-500 dark:border-zinc-700 dark:text-zinc-400", children }),
            hr: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("hr", { className: "my-3 border-zinc-200 dark:border-zinc-800" }),
            strong: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("strong", { className: "font-semibold", children }),
            table: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "my-2 overflow-x-auto rounded-lg border border-zinc-200 dark:border-zinc-800", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("table", { className: "w-full min-w-max border-collapse text-left text-xs", children }) }),
            thead: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("thead", { className: "bg-zinc-100 dark:bg-zinc-900", children }),
            th: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { className: "border-b border-zinc-200 px-2.5 py-1.5 font-semibold text-zinc-700 dark:border-zinc-800 dark:text-zinc-300", children }),
            td: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { className: "border-b border-zinc-100 px-2.5 py-1.5 text-zinc-600 last:border-b-0 dark:border-zinc-900 dark:text-zinc-400", children }),
            code: ({ className: codeClassName, children }) => {
              const isBlock = /language-/.test(codeClassName || "");
              if (isBlock) return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CodeBlock, { className: codeClassName, children });
              return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("code", { className: "rounded-md bg-zinc-100 px-1.5 py-0.5 font-mono text-[0.85em] text-zinc-800 dark:bg-zinc-900 dark:text-zinc-200", children });
            },
            pre: ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children })
          },
          children: content
        }
      )
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "mb-2 overflow-hidden rounded-xl border border-zinc-200/70 bg-zinc-50/60 text-xs dark:border-zinc-800/70 dark:bg-zinc-950/40", children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: "flex items-center gap-1.5", children: [
            isReasoning ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react5.Loader2, { className: "size-3 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react5.BrainCircuit, { className: "size-3" }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "font-medium", children: isReasoning ? "Thinking\u2026" : "Thought process" })
          ] }),
          isOpen ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react5.ChevronDown, { className: "size-3" }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react5.ChevronRight, { className: "size-3" })
        ]
      }
    ),
    isOpen && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "whitespace-pre-wrap break-words border-t border-zinc-200/60 p-2.5 text-zinc-500 dark:border-zinc-800/60 dark:text-zinc-400", children: reasoning })
  ] });
}
function PersonaMessageFeed({
  ...
  if (messages.length === 0 && isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: cn("flex min-h-0 flex-1 items-center justify-center p-8", className), children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "size-5 animate-spin rounded-full border-2 border-zinc-300 border-t-zinc-600 dark:border-zinc-700 dark:border-t-zinc-300" }) });
  }
  if (messages.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: cn("flex min-h-0 flex-1 flex-col items-center justify-center p-8 text-center", className), children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "mb-4 flex size-12 items-center justify-center rounded-2xl bg-zinc-100 text-zinc-900 shadow-2xs dark:bg-zinc-800 dark:text-zinc-100", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react5.Sparkles, { className: "size-6" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h2", { className: "text-xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-100 md:text-2xl", children: greeting })
    ] });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: cn("min-h-0 flex-1 space-y-6 overflow-y-auto p-4 md:p-6", className), children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "mx-auto max-w-3xl space-y-6", children: [
    messages.map((msg) => {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
              "div",
              {
                ...
                children: [
                  !isUser && msg.reasoning && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ReasoningBlock, { reasoning: msg.reasoning, isReasoning: msg.isReasoning }),
                  msg.toolCalls && msg.toolCalls.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "mb-2 space-y-1", children: groupTools ? groupToolCalls(msg.toolCalls).map(
                    (item) => item.type === "group" ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                      PersonaToolGroup,
                      {
                        tools: item.tools,
                        toolRenderers,
                  ...
                  ) : msg.toolCalls.map((tc) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                    PersonaToolTrace,
                    {
                      toolCall: tc,
                      toolRenderers,
                  ...
                  isUser ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "whitespace-pre-wrap break-words", children: msg.content }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(PersonaMarkdown, { content: msg.content }),
                  msg.isStreaming && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "inline-block size-2 ml-1 rounded-full bg-blue-500 animate-pulse" }),
                  !isUser && !msg.isStreaming && msg.content && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "mt-2 flex items-center justify-end gap-1 opacity-0 transition-opacity group-hover:opacity-100", children: [
                    onReload && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                      "button",
                      {
                        type: "button",
                        onClick: onReload,
                        ...
                        children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react5.RotateCcw, { className: "size-3" })
                      }
                    ),
                    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                      "button",
                      {
                        ...
                        title: "Copy message",
                        className: "rounded p-1 text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-200",
                        children: copiedId === msg.id ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react5.Check, { className: "size-3 text-emerald-500" }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react5.Copy, { className: "size-3" })
                      }
                    )
                  ] })
                ]
            ...
            isUser && showUserAvatar && (userAvatar ?? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "mt-0.5 flex size-8 shrink-0 select-none items-center justify-center rounded-xl bg-[var(--persona-user-avatar-bg,#e4e4e7)] text-[var(--persona-user-avatar-text,#3f3f46)] shadow-2xs dark:bg-[var(--persona-user-avatar-bg,#27272a)] dark:text-[var(--persona-user-avatar-text,#d4d4d8)]", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react5.User, { className: "size-4" }) }))
          ]
        },
        msg.id
      );
    }),
    error && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "rounded-xl border border-red-200 bg-red-50 p-3 text-center text-xs text-red-600 dark:border-red-900/50 dark:bg-red-950/40 dark:text-red-400", children: error.message || "Failed to communicate with agent." }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { ref: scrollEndRef })
  ] }) });
}
...
function PersonaComposer({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: cn("relative w-full max-w-3xl mx-auto", className), children: [
    starterPrompts.length > 0 && !input && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "mb-2 flex flex-wrap items-center gap-1.5 px-1", children: starterPrompts.map((item) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "relative flex flex-col rounded-2xl border border-zinc-200 bg-white p-2.5 shadow-sm transition-all focus-within:border-zinc-400 focus-within:ring-2 focus-within:ring-zinc-400/20 dark:border-zinc-700 dark:bg-zinc-900", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex items-center gap-1", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
            "button",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_lucide_react6.Paperclip, { className: "size-4" })
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { children: isStreaming ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "button",
          {
            type: "button",
            onClick: onStop,
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_lucide_react6.Square, { className: "size-3.5 fill-white" })
          }
        ) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_lucide_react6.ArrowUp, { className: "size-4 stroke-[2.5]" })
          }
        ) })
      ] })
    ] })
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
      "aside",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center justify-between gap-2 border-b border-zinc-200/80 p-3 dark:border-zinc-800/80", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex min-w-0 rounded-xl bg-zinc-200/60 p-0.5 dark:bg-zinc-800/60", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
                "button",
                {
                  type: "button",
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_lucide_react7.Files, { className: "size-3.5 shrink-0" }),
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "hidden sm:inline", children: "Files" }),
                    files.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "text-[10px] opacity-70", children: [
                      "(",
                      files.length,
                      ")"
                    ] })
              ...
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_lucide_react7.FolderKanban, { className: "size-3.5 shrink-0" }),
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "hidden sm:inline", children: "Workspace" }),
                    workspaceEntries.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "text-[10px] opacity-70", children: [
                      "(",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_lucide_react7.Brain, { className: "size-3.5 shrink-0" }),
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "hidden sm:inline", children: "Memory" }),
                    memory?.userFiles?.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "text-[10px] opacity-70", children: [
                      "(",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "button",
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_lucide_react7.X, { className: "size-4" })
              }
            )
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "min-h-0 flex-1 overflow-y-auto p-3", children: tab === "files" ? (
            /* Uploaded files list */
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "space-y-2", children: files.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "py-8 text-center text-xs text-zinc-400", children: "No uploaded files yet." }) : files.map((file) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex min-w-0 items-center gap-2", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_lucide_react7.FileText, { className: "size-4 shrink-0 text-blue-500" }),
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "min-w-0 truncate", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "block truncate text-xs font-medium text-zinc-800 dark:text-zinc-200", children: file.originalName }),
                      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-[10px] text-zinc-400", children: file.size ? `${(file.size / 1024).toFixed(1)} KB` : "" })
                    ] })
                  ] }),
                  onDeleteFile && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                    "button",
                    {
                      type: "button",
                      onClick: () => onDeleteFile(file.id),
                      className: "shrink-0 rounded p-1 text-zinc-400 hover:text-red-500",
                      children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_lucide_react7.Trash2, { className: "size-3.5" })
                    }
                  )
                ]
              },
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "space-y-4", children: selectedWorkspaceFile ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center justify-between gap-2 border-b border-zinc-200/80 pb-2 dark:border-zinc-800/80", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "truncate text-xs font-semibold text-zinc-800 dark:text-zinc-200", children: selectedWorkspacePath }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex shrink-0 items-center gap-1", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                    "button",
                    {
                      ...
                      children: copied ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_lucide_react7.Check, { className: "size-3 text-emerald-500" }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_lucide_react7.Copy, { className: "size-3" })
                    }
                  ),
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                    "button",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("pre", { className: "mt-2 overflow-x-auto whitespace-pre-wrap break-words rounded-lg bg-zinc-100 p-2.5 font-mono text-[11px] text-zinc-800 dark:bg-zinc-900 dark:text-zinc-200", children: selectedWorkspaceFile.content })
            ] }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
              todos.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "px-0.5 text-[11px] font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500", children: "Plan" }),
                todos.map((todo, i) => {
              ...
              workspaceEntries.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "py-8 text-center text-xs text-zinc-400", children: "No workspace files yet \u2014 files the agent creates show up here." }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-1.5", children: [
                todos.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "px-0.5 text-[11px] font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500", children: "Files" }),
                workspaceEntries.map(([path, file]) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
                  "button",
                  {
                    type: "button",
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex min-w-0 items-center gap-2", children: [
                        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_lucide_react7.FileText, { className: "size-3.5 shrink-0 text-amber-500" }),
                        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "truncate text-zinc-800 dark:text-zinc-200", children: path })
                      ] }),
                      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "shrink-0 text-[10px] text-zinc-400", children: file.size ? `${(file.size / 1024).toFixed(1)} KB` : "" })
                    ]
                  },
                  path
                ))
            ...
            /* Memory inspector */
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "space-y-3", children: selectedMemory ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center justify-between gap-2 border-b border-zinc-200/80 pb-2 dark:border-zinc-800/80", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "truncate text-xs font-semibold text-zinc-800 dark:text-zinc-200", children: selectedMemory.path }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex shrink-0 items-center gap-1", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                    "button",
                    {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("pre", { className: "mt-2 overflow-x-auto whitespace-pre-wrap break-words rounded-lg bg-zinc-100 p-2.5 font-mono text-[11px] text-zinc-800 dark:bg-zinc-900 dark:text-zinc-200", children: selectedMemory.content })
            ] }) : (memory?.userFiles?.length ?? 0) === 0 && (memory?.agentMemories?.length ?? 0) === 0 ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "py-8 text-center text-xs text-zinc-400", children: "No persistent memory files recorded." }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-4", children: [
              (memory?.userFiles?.length ?? 0) > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "space-y-1.5", children: memory.userFiles.map((f) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
                "button",
                {
                  type: "button",
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex min-w-0 items-center gap-2", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_lucide_react7.Brain, { className: "size-3.5 shrink-0 text-purple-500" }),
                      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "truncate text-zinc-800 dark:text-zinc-200", children: f.path })
                    ] }),
                    loadingMemory && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_lucide_react7.Loader2, { className: "size-3 shrink-0 animate-spin text-zinc-400" })
                  ]
                },
                f.path
              )) }),
              memory?.agentMemories?.map((group) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "px-0.5 text-[11px] font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500", children: group.agentName || "Unknown Agent" }),
                group.files.map((f) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
                  "button",
                  {
                    type: "button",
                    onClick: () => viewMemoryFile(f.path),
...
function PersonaInterruptCard({
  ...
  if (interrupt.kind === "hitl") {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "mb-2 flex items-center gap-2 font-semibold text-amber-800 dark:text-amber-300", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_lucide_react8.ShieldAlert, { className: "size-4" }),
            "Approval needed"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("ul", { className: "mb-3 space-y-1 font-mono text-xs text-amber-900/80 dark:text-amber-200/80", children: interrupt.actionRequests.map((action, i) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("li", { children: [
            "\u2022 ",
            action.name
          ] }, i)) }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_lucide_react8.Check, { className: "size-3.5" }),
                  " Approve"
                ]
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_lucide_react8.X, { className: "size-3.5" }),
                  " Reject"
                ]
              }
            )
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "mb-3 flex items-center gap-2 font-semibold text-blue-800 dark:text-blue-300", children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_lucide_react8.HelpCircle, { className: "size-4" }),
          "A few questions before I continue"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "space-y-3", children: interrupt.questions.map((q, i) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: "mb-1.5 text-xs font-medium text-blue-900 dark:text-blue-200", children: q.text }),
          q.options.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "mb-1.5 flex flex-wrap gap-1.5", children: q.options.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            "button",
            {
              type: "button",
          ...
          q.allowCustom && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            "input",
            {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cn("flex min-h-0 flex-1 flex-col", classNames.main), children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex h-11 shrink-0 items-center justify-between border-b border-zinc-200 bg-white px-3 dark:border-zinc-800 dark:bg-zinc-950", children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
                "button",
                {
                  ...
                  children: sidebarOpen ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_lucide_react9.PanelLeftClose, { className: "size-4" }) : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_lucide_react9.PanelLeft, { className: "size-4" })
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "text-sm font-semibold text-zinc-800 dark:text-zinc-200", children: title })
            ] }),
            showFilesDrawer && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
              "button",
              {
                type: "button",
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_lucide_react9.Files, { className: "size-3.5" }),
                  /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { children: "Artifacts" })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "flex min-h-0 flex-1 flex-col", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
            PersonaMessageFeed,
            {
              messages,
              isStreaming,
          ...
          interrupt && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "shrink-0 border-t border-zinc-100 bg-white px-3 pt-3 dark:border-zinc-800 dark:bg-zinc-950", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        ...
        showFilesDrawer && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          PersonaFilesDrawer,
          {
